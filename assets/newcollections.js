...
import p8_img from '../assets/p4.webp'
import p9_img from '../assets/6.webp'
import p10_img from '../assets/7.jpg'
import p11_img from '../assets/8.avif'
let new_collections = [
     { id: 5, name: "T-Shirt", category: "women", image: p1_img, new_price: 45.0, old_price: 70.0 },
        { id: 6, name: "Dress", category: "men", image: p5_img, new_price: 85.0, old_price: 130.0 },
        { id: 7, name: "Pant", category: "men", image: p6_img, new_price: 95.0, old_price: 150.0 },
        { id: 8, name: "Leggings", category: "women", image: p7_img, new_price: 55.0, old_price: 100.0 },
        { id: 9, name: "Jacket", category: "men", image: p8_img, new_price: 70.0, old_price: 110.0 },
